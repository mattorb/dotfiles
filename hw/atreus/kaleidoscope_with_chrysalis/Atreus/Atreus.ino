...
// we expect these hardcoded layers to be overridden by EEPROM/Chrysalis:
...
KEYMAPS(
  ...
  (
      ...
      ,Key_Esc ,Key_LeftShift, Key_LeftControl, Key_LeftAlt, Key_LeftGui, Key_Backspace 

                     ,Key_Y     ,Key_U      ,Key_I     ,Key_O      ,Key_P
                     ,Key_H     ,Key_J      ,Key_K     ,Key_L      ,Key_Semicolon
       ,Key_Backslash,Key_N     ,Key_M      ,Key_Comma ,Key_Period ,Key_Slash
       ,Key_Tab, Key_Space ,MO(FUN)    ,Key_Minus ,Key_Quote  ,Key_Enter
  ),
